...
class WebAppCustomerBuilder(ICustomerBuilder):
    ...
    def middleName(self, value: str | None):
        self._product.add("middleName", value)
    ...
    def secondaryEmail(self, value: str | None):
        self._product.add("secondaryEmail", value)
    ...
    def secondaryMobileNumber(self, value: str | None):
        self._product.add("secondaryMobileNumber", value)
